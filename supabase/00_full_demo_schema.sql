-- Locative - esquema final consolidado para demo academica.
-- Usar este archivo para levantar una base nueva desde cero.
-- Luego ejecutar 02_rls.sql y las funciones operativas indicadas en README_SQL.md.
...
create index if not exists idx_repair_requests_created_by_id on public.repair_requests(created_by_id);
